...
![大规模benchmark整体设计](images/fig01_benchmark_overview.png)
...
![E. coli编码区域和基因长度比较](images/fig02_ecoli_coding_density.png)
...
![跨细菌和古菌的工具表现](images/fig03_taxonomy_performance.png)
...
![MAG和移码错误对注释的影响](images/fig04_mag_frameshift.png)
...
![原核基因组注释工具选择决策树](images/fig05_decision_tree.png)
